"""CLI for exact PR9 card vectors and fail-closed verification."""
...
def register_rappid_card_parser(subparsers: Any) -> None:
    ...
    fixtures = commands.add_parser(
        "fixtures", help="Export the vendored PR9 conformance deck and QR artifacts"
    )
    ...
    verify = commands.add_parser(
        "verify", help="Verify one vendored scenario at its exact ordered PR9 step"
    )
