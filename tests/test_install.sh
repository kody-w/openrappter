...
assert_contains "$script_content" "python3.13" "script discovers versioned Python installations"
assert_contains "$script_content" "python_cmd_meets_min" "script validates each Python candidate"
assert_contains "$script_content" ".venv/bin/python" "launcher uses the isolated Python environment"
