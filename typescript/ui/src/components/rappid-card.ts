  ...
  render() {
    ...
    return html`
      <div class="shell">
        <section class="hero">
          <div>
            <div class="eyebrow">RAPP/1 §7.10 · test vectors only</div>
        ...
        <div class="grid">
          <section class="panel">
            <div class="qr">
              ${this.run
                ? html`<img src=${this.qrSource(this.run.qr_svg)} alt="Scannable RAPP/1 §7.10 compact RAPPID URI" />`
                : nothing}
            </div>
